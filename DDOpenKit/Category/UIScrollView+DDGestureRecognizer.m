//
//  UIScrollView+DDGestureRecognizer.m
//  TigerSchool
//
//  Created by 红领巾 on 2018/8/8.
//  Copyright © 2018 百e国际. All rights reserved.
//

#import "UIScrollView+DDGestureRecognizer.h"
#define IPHONE_H [UIScreen mainScreen].bounds.size.height //屏幕的高度
#define IPHONE_W [UIScreen mainScreen].bounds.size.width // 屏幕的宽度

@implementation UIScrollView (DDGestureRecognizer)
