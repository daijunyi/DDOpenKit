...
@interface PDWebView()<WKNavigationDelegate,UIWebViewDelegate,WKUIDelegate>
@property (nonatomic,strong)NSTimer *fakeProgressTimer;         /**< 计时器*/
@property (nonatomic,assign)BOOL uiWebViewIsLoading;        /**< 网页是否加载*/
@property (nonatomic,strong)NSURL *uiWebViewCurrentURL;     /**< 网页*/
...
- (void)setBackgroundColor:(UIColor *)backgroundColor{
    ...
    self.uiWebView.backgroundColor = backgroundColor;
    self.wkWebView.backgroundColor = backgroundColor;
}
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation {
    ...
    [webView evaluateJavaScript:@"document.getElementById(\"content\").offsetHeight;" completionHandler:^(id _Nullable height, NSError * _Nullable error) {
        CGFloat documentHeight = [height doubleValue];
